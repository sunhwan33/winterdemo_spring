...
public class DefaultController {
    ...
    public byte[] getImage(@PathVariable("file_name") String file_name) {
        String root_path = "C:/workspace/uploadfiles/winterspradv/";
    ...
    public void download(@PathVariable("file_name") String file_name, HttpServletResponse response) throws IOException {
        ...
        String dfilename = URLEncoder.encode(file.getName(), "utf-8");
        int firsttemp = dfilename.indexOf("_");
        dfilename = dfilename.substring(firsttemp + 1, dfilename.length());
